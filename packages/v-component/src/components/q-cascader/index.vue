...
onMounted(() => {
  tempNodes.value = cloneDeep(props.options) as Array<any>;
});

watch(() => props.options, (value, oldValue, onCleanup) => {
  tempNodes.value = cloneDeep(value) as Array<any>;
})
 ...
 * @param value
 */
const updateNodeInTree = (treeList: Array<any>, key: string, prop: string, value: any) => {
