...
//     };
//     this.registerEventHandlers(PARENT_EVENTBUS_NAME, this.eventMap[PARENT_EVENTBUS_NAME]);
//   };
...
//     this.registerEventHandlers(EVENTBUS_NAME, this.eventMap[EVENTBUS_NAME]);
//   };
...
//     const socket = connect(SOCKET_ADDRESS, {
//       path: `/${SOCKET_SUBSCRIBE_ADDRESS}`,
//     });
...
//       const { id: itemId = "", src: targetSrc, trigger = [], receive = [] } = item;
...
//         options,
//       });
//       const customEvent = new CustomEvent(EVENTBUS_NAME, {
//         detail: imessage,
//       });
