...
import { ChangeConfigInfo } from "@zzjz/v-uibuilder-types";
 ...
 */
export function changeRouterSource(pageModel: any) {
  if (pageModel?._selectedComponents.length === 1) {
    const id = pageModel._selectedComponents[0].id;
